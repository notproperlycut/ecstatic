defmodule Ecstatic.Commanded.Events.CommandConfigured do
...
defimpl Commanded.Serialization.JsonDecoder, for: Ecstatic.Commanded.Events.CommandConfigured do
  def decode(%Ecstatic.Commanded.Events.CommandConfigured{schema: schema, handler: handler} = event) do
    %Ecstatic.Commanded.Events.CommandConfigured{
      event
